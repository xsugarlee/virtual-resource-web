...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // ✅ 去掉了 backdrop-blur，纯背景，无磨砂
        "fixed inset-0 z-50 bg-black/40 duration-75 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
